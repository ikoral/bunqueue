---
title: "Getting Started with bunqueue in 5 Minutes"
description: "A quick tutorial to set up bunqueue, create queues, add jobs, and process them with workers in embedded or TCP mode. From zero to running in 5 minutes."
head:
  - tag: meta
    attrs:
      property: og:image
