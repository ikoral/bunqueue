---
title: "Why We Built bunqueue: SQLite Over Redis"
description: "The motivation behind bunqueue - a high-performance job queue that replaces Redis with SQLite for simpler deployments and better performance on Bun."
head:
  - tag: meta
    attrs:
      property: og:image
