---
title: "Building Reliable Workers with Stall Detection"
description: "How to build reliable job workers with bunqueue's stall detection, heartbeat protocol, and lock-based ownership. Prevent lost jobs and duplicate processing."
head:
  - tag: meta
    attrs:
      property: og:image
