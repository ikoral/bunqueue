---
title: "Cron Jobs and Scheduling in bunqueue"
description: "How to use bunqueue's built-in cron scheduler for recurring jobs. Cron expressions, repeat intervals, timezone support, and execution limits."
head:
  - tag: meta
    attrs:
      property: og:image
