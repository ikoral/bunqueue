---
title: "Integrating bunqueue with Hono and Elysia"
description: "Practical patterns for integrating bunqueue with popular Bun web frameworks. Queue jobs from HTTP handlers, middleware patterns, and graceful shutdown."
head:
  - tag: meta
    attrs:
      property: og:image
