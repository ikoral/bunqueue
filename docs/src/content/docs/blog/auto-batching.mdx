---
title: "Auto-Batching: 3x Throughput for Free"
description: "How bunqueue's auto-batching system transparently groups concurrent add() calls into bulk operations, delivering 3x throughput with zero code changes."
head:
  - tag: meta
    attrs:
      property: og:image
