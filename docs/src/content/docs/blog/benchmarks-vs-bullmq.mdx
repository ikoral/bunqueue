---
title: "bunqueue vs BullMQ: Real Benchmark Results"
description: "Fair, reproducible benchmarks comparing bunqueue TCP mode against BullMQ with Redis. Push, bulk, processing, and end-to-end throughput numbers."
head:
  - tag: meta
    attrs:
      property: og:image
