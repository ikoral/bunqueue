---
title: "Deep Dive: How Sharding Distributes Jobs Across CPU Cores"
description: "An in-depth look at bunqueue's sharding architecture - FNV-1a hashing, power-of-2 shard counts, and how jobs are distributed for maximum throughput."
head:
  - tag: meta
    attrs:
      property: og:image
