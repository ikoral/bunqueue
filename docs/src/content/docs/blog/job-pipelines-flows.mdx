---
title: "Building Job Pipelines with FlowProducer"
description: "How to create job pipelines and dependency trees with bunqueue's FlowProducer. Parent-child relationships, fan-out patterns, and chain processing."
head:
  - tag: meta
    attrs:
      property: og:image
