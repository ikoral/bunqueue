...
<Aside type="tip" title="60+ workflow tests">
The workflow engine ships with 60+ tests covering linear flows, branching, compensation, signals, timeouts, retry, parallel steps, nested workflows, observability, and archival — in both embedded and TCP modes.
</Aside>
